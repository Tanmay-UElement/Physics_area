...
export default function ClassSelectPage() {
  ...
  const voltConcepts = [
    ...
    { num: 5, name: 'Generator Crank', type: 'Faraday\'s Law', status: 'PLANNED', playable: false },
    { num: 6, name: 'Series vs. Parallel Puzzle', type: 'Circuit Combination', status: 'PLANNED', playable: false },
    { num: 7, name: 'Power Grid Balancer', type: 'Power Law (P = VI)', status: 'PLANNED', playable: false },
    ...
    <div className={`min-h-screen flex flex-col selection:bg-cyan-500 selection:text-slate-950 transition-colors ${
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-6 py-12 space-y-12">
        ...
        <div className="text-center space-y-3 max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-purple-500/10 border border-purple-500/30 text-purple-400 text-xs font-mono font-bold">
            <Sparkles className="w-4 h-4" />
            <span>5 PHYSICS CLASSES • 11 GAMES ACTIVE</span>
          </div>
          <h1 className="text-4xl sm:text-5xl font-black tracking-tight">
            Select Physics Class
          </h1>
          <p className={`text-sm sm:text-base ${isLight ? 'text-slate-600' : 'text-slate-300'}`}>
            Master Kinetic and Volt mechanics to build deep physical intuition through numerical calculation!
          </p>
        </div>
        ...
        {/* 2. VOLT CLASS (NEWLY UNLOCKED & ACTIVE) */}
        <div className={`p-8 rounded-3xl border-2 shadow-2xl space-y-8 relative overflow-hidden transition-all ${
          isLight
          ...
          <div className={`flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10 border-b pb-6 ${
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="px-2 py-0.5 rounded text-[10px] font-mono font-bold bg-purple-500/20 text-purple-400 border border-purple-500/40">
                    UNLOCKED • 5 GAMES ACTIVE
                  </span>
                </div>
                <h2 className="text-3xl font-black">Volt Class</h2>
                <p className={`text-xs ${isLight ? 'text-slate-600' : 'text-slate-300'}`}>
                  Electricity & Magnetism — Ohm's Law, Coulomb Tug, Lorentz Field Deflection & Kirchhoff Network
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              <Link
                href="/match/volt-circuit-builder"
          ...
          <div className="space-y-4 relative z-10">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs font-mono text-slate-400">5 Playable Now</span>
            </div>
        ...
        {/* 3-5. POST-MVP FUTURE CLASSES GRID (THERMO, WAVE, ORBIT) */}
        <div className="space-y-6 pt-4">
          <div className="flex items-center justify-between">
            <h2 className="text-2xl font-black flex items-center gap-2">
              <Lock className="w-5 h-5 text-slate-400" />
              <span>Future Physics Classes (Classes 3 - 5)</span>
            </h2>
